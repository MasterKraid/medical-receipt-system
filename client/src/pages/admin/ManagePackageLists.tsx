            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm border border-gray-200">
                ...
                <fieldset className="border-2 border-gray-300 p-4 md:p-6 rounded-xl mb-10">
                    <legend className="px-3 flex items-center gap-2">
                        ...
                        <span className="text-base md:text-lg font-bold text-gray-800 uppercase tracking-tight md:tracking-normal">Add Rate List</span>
                    </legend>
                ...
                <div className="relative flex flex-col">
                    ...
                    <fieldset className="border-2 border-gray-300 p-4 md:p-6 rounded-xl order-2 min-w-0">
                        <legend className="px-3 flex items-center gap-2">
                            ...
                            <span className="text-base md:text-lg font-bold text-gray-800 uppercase tracking-tight md:tracking-normal">Available Rate Lists</span>
                        </legend>
