    ...
    return (
        <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 border-b border-gray-300 pb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-lg font-bold text-gray-800">Account Directory</h2>
                    </div>
                            ...
                            <div key={client.id} className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden flex flex-col">
                                ...
                                <div className="flex justify-between items-start mb-4">
                                    <div className="pl-2">
                                        ...
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">{client.username}</p>
                                    </div>
                                ...
                                <div className="grid grid-cols-3 gap-1.5">
                                    <button onClick={() => openModal(client, 'add')} className="flex flex-col items-center justify-center py-1.5 px-1 bg-green-50 text-green-700 rounded-lg hover:bg-green-600 hover:text-white transition-all border border-green-100">
                                        <i className="fa-solid fa-plus text-[9px] mb-0.5"></i>
                                        <span className="text-[8px] font-black uppercase">Credit</span>
                                    </button>
                                    <button onClick={() => openModal(client, 'deduct')} className="flex flex-col items-center justify-center py-1.5 px-1 bg-red-50 text-red-700 rounded-lg hover:bg-red-600 hover:text-white transition-all border border-red-100">
                                        <i className="fa-solid fa-minus text-[9px] mb-0.5"></i>
                                        <span className="text-[8px] font-black uppercase">Debit</span>
                                    </button>
                                    <button onClick={() => openModal(client, 'settle')} className="flex flex-col items-center justify-center py-1.5 px-1 bg-gray-50 text-gray-600 rounded-lg hover:bg-gray-800 hover:text-white transition-all border border-gray-100">
